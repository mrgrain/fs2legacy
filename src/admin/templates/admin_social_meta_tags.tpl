...
<form action="" method="post">
    ...
    <table class="content config" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td>
                <input class="half" name="default_image" id="default_image" maxlength="255"
                       value="<!--TEXT::default_image-->"><br>
        ...
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="use_external_images" value="1"
                <!--IF::use_external_images-->checked<!--ENDIF-->>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="use_news_cat_prepend" value="1"
                <!--IF::use_news_cat_prepend-->checked<!--ENDIF-->
                onChange="$('#use_news_cat_prepend_tr').toggle()" >
            </td>
        </tr>
        <tr
        <!--IF::use_news_cat_prepend--><!--ELSE-->class="hidden"<!--ENDIF--> id="use_news_cat_prepend_tr">
        <td>
            <!--LANG::news_cat_prepend--> <span class="small">(<!--COMMON::optional-->)</span><br>
            <span class="small"><!--LANG::news_cat_prepend_desc--></span>
        </td>
        <td>
            <input class="half" name="news_cat_prepend" id="news_cat_prepend" maxlength="20"
                   value="<!--TEXT::news_cat_prepend-->">
        </td>
        </tr>


        <tr>
            <td colspan="2"><h3><!--LANG::googleplus_title--></h3>
                <hr>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="use_google_plus" value="1" <!--IF::use_google_plus-->checked
                <!--ENDIF-->
                onChange="$('#use_google_plus_tr').toggle()" >
            </td>
        </tr>
        <tr
        <!--IF::use_google_plus--><!--ELSE-->class="hidden"<!--ENDIF--> id="use_google_plus_tr">
        <td>
            <!--LANG::google_plus_page--><br>
            <span class="small"><!--LANG::google_plus_page_desc--></span>
        </td>
        <td>
            <input class="half" name="google_plus_page" id="google_plus_page" maxlength="100"
                   value="<!--TEXT::google_plus_page-->">
        </td>
        </tr>


        <tr>
            <td colspan="2"><h3><!--LANG::twitter_title--></h3>
                <hr>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="use_twitter_card" value="1" <!--IF::use_twitter_card-->
                checked<!--ENDIF-->
                onChange="$('#use_twitter_card_tr').toggle()" >
            </td>
        </tr>
        <tr
        <!--IF::use_twitter_card--><!--ELSE-->class="hidden"<!--ENDIF--> id="use_twitter_card_tr">
        <td>
        ...
        <tr>
            <td colspan="2"><h3><!--LANG::facebook_title--></h3>
                <hr>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="use_open_graph" value="1" <!--IF::use_open_graph-->checked
                <!--ENDIF-->
        ...
        <tr>
            <td colspan="2"><h3><!--LANG::schemaorg_title--></h3>
                <hr>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden middle" type="checkbox" name="use_schema_org" value="1" <!--IF::use_schema_org-->
                checked<!--ENDIF-->><br>
        ...
        <tr>
            <td colspan="2"><h3><!--LANG::enable_for_title--></h3>
                <hr>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="enable_news" value="1" <!--IF::enable_news-->checked
                <!--ENDIF-->>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="enable_articles" value="1" <!--IF::enable_articles-->checked
                <!--ENDIF-->>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="enable_downloads" value="1" <!--IF::enable_downloads-->
                checked<!--ENDIF-->>
            </td>
        </tr>
