...
<form action="" method="post">
    ...
    <table class="content config" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="2"><h3><!--LANG::pageinfo_title--></h3>
                <hr>
            </td>
        </tr>
        ...
        <tr
        <!--IF::dyn_title_ext-->class="hidden"<!--ENDIF--> id="dyn_title_ext_tr">
        <td>
            <!--LANG::dyn_title_ext--><br>
            <span class="small"><!--LANG::dyn_title_ext_desc--></span>
        </td>
        <td>
            <input class="half" name="dyn_title_ext" id="dyn_title_ext" maxlength="100"
                   value="<!--TEXT::dyn_title_ext-->"><br>
        ...
        <tr>
            ...
            <td>
                <select name="protocol">
                    <option value="http://"
                    <!--IF::protocol_http-->selected<!--ENDIF-->>http://</option>
                    <option value="https://"
                    <!--IF::protocol_https-->selected<!--ENDIF-->>https://</option>
                </select>
        ...
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="other_protocol" value="1" <!--IF::other_protocol-->checked
                <!--ENDIF-->>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2"><h3><!--LANG::design_title--></h3>
                <hr>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden pointer" type="checkbox" name="allow_other_designs" value="1"
                <!--IF::allow_other_designs-->checked<!--ENDIF-->>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden pointer" type="checkbox" name="show_favicon" value="1"<!--IF::show_favicon-->
                checked<!--ENDIF-->>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <select class="half" name="feed" size="1">
                    <option value="rss091"
                    <!--IF::feed_rss091-->selected<!--ENDIF-->>
                    <!--LANG::feed_rss091-->
                    </option>
                    <option value="rss10"
                    <!--IF::feed_rss10-->selected<!--ENDIF-->>
                    <!--LANG::feed_rss10-->
                    </option>
                    <option value="rss20"
                    <!--IF::feed_rss20-->selected<!--ENDIF-->>
                    <!--LANG::feed_rss20-->
                    </option>
                    <option value="atom10"
                    <!--IF::feed_atom10-->selected<!--ENDIF-->>
                    <!--LANG::feed_atom10-->
                    </option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td>
                <select class="half" name="url_style" size="1">
                    ...
                    <!--IF::url_style_default-->selected<!--ENDIF-->>
                    <!--LANG::url_style_default-->
                    </option>
                    <option value="seo"
                    <!--IF::url_style_seo-->selected<!--ENDIF-->>
                    <!--LANG::url_style_seo-->
                    </option>
                </select>
                <br>
        ...
        <tr>
            ...
            <td>
                <input class="center" size="2" name="auto_forward" maxlength="2" value="<!--TEXT::auto_forward-->">
                <!--COMMON::seconds-->
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <select class="half" name="count_referers" size="1">
                    <option value="1"
                    <!--IF::ref_active-->selected<!--ENDIF-->>
                    <!--LANG::referer_active-->
                    </option>
                    <option value="0"
                    <!--IF::ref_inactive-->selected<!--ENDIF-->>
        ...
        <tr>
            <td colspan="2"><h3><!--LANG::pagenav_title--></h3>
                <hr>
            </td>
        </tr>
