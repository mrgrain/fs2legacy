...
<form action="" method="post">
    ...
    <table class="content config" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan="2"><h3><!--LANG::search_config_title--></h3>
                <hr>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input class="center" name="search_num_previews" maxlength="2" size="3"
                       value="<!--TEXT::search_num_previews-->">
                <!--COMMON::results--><br>
        ...
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="search_allow_phonetic" value="1"
                <!--IF::search_allow_phonetic-->checked<!--ENDIF-->>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input class="half" name="search_wildcard" maxlength="255" size="20"
                       value="<!--TEXT::search_wildcard-->">
                <span class="small">[<!--COMMON::csv-->]</span>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2"><h3><!--LANG::search_index_title--></h3>
                <hr>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <select name="search_index_update" size="1">
                    <option value="1"
                    <!--IF::search_index_update_1-->selected<!--ENDIF-->><!--LANG::index_update_instantly--></option>
                    <option value="2"
                    <!--IF::search_index_update_2-->selected<!--ENDIF-->><!--LANG::index_update_daily--></option>
                    <option value="3"
                    <!--IF::search_index_update_3-->selected<!--ENDIF-->><!--LANG::index_update_never--></option>
                </select>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <!--COMMON::checkbox-->
                <input class="hidden" type="checkbox" name="search_use_stopwords" value="1"
                <!--IF::search_use_stopwords-->checked<!--ENDIF-->>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input class="center" name="search_min_word_length" maxlength="3" size="4"
                       value="<!--TEXT::search_min_word_length-->">
                <!--COMMON::chars--><br>
            </td>
        </tr>
