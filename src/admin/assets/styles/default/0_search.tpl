...
<form method="get" action="">
    ...
    <input class="small input input_highlight middle" id="mini_search_keyword" name="keyword" size="13" maxlength="100"
           value="">
...
<fieldset>
    ...
    <form method="get" action="">
        ...
        <p id="extended_search" class="hidden" style="width:100%">
            ...
            <input class="pointer middle" type="checkbox" id="search_news" name="in_news"
                   value="1" {..search_in_news..}>
            <label class="pointer middle" for="search_news">News</label>
            <input class="pointer middle" type="checkbox" id="search_articles" name="in_articles"
                   value="1" {..search_in_articles..}>
            <label class="pointer middle" for="search_articles">Artikeln</label>
            <input class="pointer middle" type="checkbox" id="search_downloads" name="in_downloads"
                   value="1" {..search_in_downloads..}>
            <label class="pointer middle" for="search_downloads">Downloads</label>

      <span class="atright">
        <input class="pointer middle" type="checkbox" id="phonetic_search" name="phonetic_search"
               value="1" {..phonetic_search..}>
