...
<!--section-start::NAVIGATION_LINE--><img style="margin:3px 2px 3px 0px; vertical-align: middle;" src="{..icon_url..}"
                                          alt="{..cat_name..}">
...
<!--section-start::ENTRY_FILE_IS_MIRROR-->
<td class="dl_cell" align="center" valign="middle"><b>Mirror!</b></td><!--section-end::ENTRY_FILE_IS_MIRROR-->

<!--section-start::ENTRY_STATISTICS-->
<tr>
