<!--section-start::SYSTEMMESSAGE--><p>
    <b>{..message_title..}</b><br>
    {..message..}
</p><!--section-end::SYSTEMMESSAGE-->

<!--section-start::FORWARDMESSAGE--><p>
    <b>{..message_title..}</b><br>
    {..message..}<br>
    <br>Du wirst jetzt automatisch weitergeleitet.<br>
    Falls dein Browser keine automatische Weiterleitung unterst&uuml;tzt, <a href="{..forward_url..}">klicke bitte
        hier</a>.
</p>
