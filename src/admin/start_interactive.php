...
$date = date('U');
$index = $FD->db()->conn()->query('SELECT * FROM ' . $FD->db()->getPrefix() . "poll WHERE poll_end > $date AND poll_start < $date ORDER BY poll_start DESC LIMIT 0,1 ");
