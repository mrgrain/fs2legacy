...
if (isset($_POST['dladd']) && isset($_POST['title']) && isset($_POST['text']) && !isset($_POST['files_add'])) {
    ...
    $stmt = $FD->db()->conn()->prepare(
        'INSERT INTO ' . $FD->db()->getPrefix() . "dl (cat_id, user_id, dl_date, dl_name, dl_text, dl_autor,
    ...
    // Insert Files
    $stmt = $FD->db()->conn()->prepare(
        'INSERT INTO ' . $FD->db()->getPrefix() . "dl_files (dl_id, file_name, file_url, file_size, file_is_mirror)
                     VALUES ('$id',
                             ?,
                             ?,
                             ?,
