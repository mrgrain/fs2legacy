    ...
    if (count($navi_arr) > 0) {
        foreach ($navi_arr as $value) {
            if (is_array($value) AND $open == true) {
                    ...
                    if (is_array($value2) AND $open2 == true) {
                        foreach ($value2 as $value3) {
                            ...
                            switch ($entry_arr['type']) {
                                case 3:
                                    $navi_url3 = $navi_url2 + array('lang' => $entry_arr['id']);
                                    break;
                                case 2:
                                    $navi_url3 = $navi_url2 + array('cat' => $entry_arr['id']);
                                    break;
                                default:
                                    $navi_url3 = $navi_url2 + array('game' => $entry_arr['id']);
                                    break;
                            }


                            //Icon URL erstellen, nur Unterordner von ge�ffneten Ordner anzeigen
                        ...
                        switch ($entry_arr['type']) {
                            case 3:
                                $navi_url2 = $navi_url1 + array('lang' => $entry_arr['id']);
                                break;
                            case 2:
                                $navi_url2 = $navi_url1 + array('cat' => $entry_arr['id']);
                                break;
                            default:
                                $navi_url2 = $navi_url1 + array('game' => $entry_arr['id']);
                                break;
                        }
                ...
                switch ($entry_arr['type']) {
                    case 3:
                        $navi_url1 = array('lang' => $entry_arr['id']);
                        break;
                    case 2:
                        $navi_url1 = array('cat' => $entry_arr['id']);
                        break;
                    default:
                        $navi_url1 = array('game' => $entry_arr['id']);
                        break;
                }
