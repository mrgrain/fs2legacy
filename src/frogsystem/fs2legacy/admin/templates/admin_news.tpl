...
<table class="content" cellpadding="0" cellspacing="0">
    <tr>
        <td colspan="2"><h3><!--LANG::news_information_title--></h3>
            <hr>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td>
            ...
            <input class="nshide" type="button"
                   onClick='popUp("?go=find_user&amp;id=user_id&amp;name=user_name", "_blank", 400, 500)'
                   value="<!--COMMON::change-->">
        </td>
    </tr>
    ...
    <tr>
        <td colspan="2"><h3><!--LANG::news_new_title--></h3>
            <hr>
        </td>
    </tr>
    ...
    <tr>
        <td colspan="2">
            <input class="full" maxlength="255" id="news_title" name="news_title"
                   value="<!--TEXT::news_title-->"><br><br>
        </td>
    </tr>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td class="right bottom">
                        <input class="middle" type="checkbox" id="news_active" name="news_active" value="1"
                        <!--IF::news_active-->checked<!--ENDIF-->>
                        <label for="news_active" class="small middle"><!--LANG::news_active--></label>&nbsp;&nbsp;

                        <input class="middle" type="checkbox" id="news_comments_allowed" name="news_comments_allowed"
                               value="1" <!--IF::news_comments_allowed-->checked<!--ENDIF-->>
                        <label for="news_comments_allowed" class="small middle">
                            <!--LANG::news_comments_allowed--></label>
                    </td>
                </tr>
            </table>
...
<tr class="link_entry">
    ...
    <td class="middle" width="140">
        ...
        <div class="nshide right">
            <img class="pointer" src="assets/icons/up.gif" onClick="up($(this).parents(\'tr:first\'));"
                 alt="<!--COMMON::up-->" title="<!--COMMON::up-->">&nbsp;
            <img class="pointer" src="assets/icons/down.gif" onClick="down($(this).parents(\'tr:first\'));"
                 alt="<!--COMMON::down-->" title="<!--COMMON::down-->">
            &nbsp;&nbsp;&nbsp;
            <img class="pointer" src="assets/icons/edit.gif" onClick="edit($(this).parents(\'tr:first\'));"
                 alt="<!--COMMON::edit-->" title="<!--COMMON::edit-->">&nbsp;
            <img class="pointer" src="assets/icons/delete.gif" onClick="removeLink($(this).parents(\'tr:first\'));"
                 alt="<!--COMMON::delete-->" title="<!--COMMON::delete-->">
        </div>
    </td>
</tr>
    ...
    <tr>
        ...
        <td class="middle left">
            <select class="quarter" name="<!--TEXT::target_name-->" size="1">
                <option value="0"
                <!--IF::target_0-->selected<!--ENDIF-->>
                <!--LANG::news_link_self-->
                </option>
                <option value="1"
                <!--IF::target_1-->selected<!--ENDIF-->>
