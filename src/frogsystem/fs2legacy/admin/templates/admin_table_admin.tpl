...
<form method="post" action="">
    <table class="content small" cellpadding="1" cellspacing="1" id="table_list">
        <tr>
            <td colspan="7"><h3><!--LANG::pageinfo_title--></h3>
                <hr>
            </td>
        </tr>
        <tr>
...
<tr>
    <td class="center"><input type="checkbox" id="table_id_<!--TEXT::table_name_esc-->"
                              value="<!--TEXT::table_name_esc-->" name="selected_tables[]"></td>
    ...
    <td><!--IF::has_free--><span style="color: #cc0000"><!--ENDIF--><!--TEXT::table_free--><!--IF::has_free--></span><!--ENDIF-->
    </td>
</tr>
...
<tr>
    <td></td>
    <td colspan="6"><span class="small">(<span class="link" onclick="groupselect('#table_list', true)"><!--COMMON::selection_all--></span>/<span
                    class="link" onclick="groupselect('#table_list', false)"><!--COMMON::selection_none--></span>/<span
                    class="link" onclick="groupselect('#table_list', 'invert')"><!--COMMON::selection_invert--></span>)</span>
    </td>
</tr>
<tr>
