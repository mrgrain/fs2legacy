        ...
        <tr>
            <td class="right" colspan="4">
                <select class="select_type" name="news_action" size="1">
                    <option class="select_one" value="edit"
                    <!--IF::action_edit-->selected<!--ENDIF-->><!--COMMON::selection_edit--></option>
                    <!--IF::perm_delete-->
                    <option class="select_red" value="delete"
                    <!--IF::action_delete-->selected<!--ENDIF-->><!--COMMON::selection_delete--></option>
                    <!--ENDIF-->
                    <!--IF::perm_comments-->
                    <option class="select_one" value="comments"
                    <!--IF::action_comments-->selected<!--ENDIF-->><!--LANG::selection_comments--></option>
                    <!--ENDIF-->
                </select>
            </td>
        </tr>
...
<tr class="select_entry">
    ...
    <td class="middle right quarter">
        <span class="small"><!--COMMON::at_date--> <b><!--TEXT::date--></b> <!--COMMON::at_time--> <b>
                <!--TEXT::time--></b></span>
    </td>
...
<form action="" method="get">
    ...
    <table class="content" cellpadding="3" cellspacing="0">
        <tr>
            <td colspan="2"><h3><!--LANG::filter_title--></h3>
                <hr>
            </td>
        </tr>
            ...
            <td class="middle">
                <p>
                    ...
                    <select name="search_type">
                        <option value="0"
                        <!--IF::search_type_0-->selected<!--ENDIF-->><!--LANG::search_fulltext--></option>
                        <option value="1"
                        <!--IF::search_type_1-->selected<!--ENDIF-->><!--LANG::search_id--></option>
                    </select>
            ...
            <td class="middle" colspan="2">
                <p>
                    ...
                    <select name="filter_cat">
                        <option value="0"
                        <!--IF::filter_cat-->selected<!--ENDIF-->><!--LANG::all_cats--></option>
                    ...
                    <!--LANG::filter_order-->:
                    <select name="order">
                        <option value="news_id"
                        <!--IF::order_id-->selected<!--ENDIF-->><!--LANG::filter_id--></option>
                        <option value="news_date"
                        <!--IF::order_date-->selected<!--ENDIF-->><!--LANG::filter_date--></option>
                        <option value="news_title"
                        <!--IF::order_title-->selected<!--ENDIF-->><!--LANG::filter_newstitle--></option>
                    </select>
                    <select name="sort">
                        <option value="ASC"
                        <!--IF::sort_asc-->selected<!--ENDIF-->><!--COMMON::asc--></option>
                        <option value="DESC"
                        <!--IF::sort_desc-->selected<!--ENDIF-->><!--COMMON::desc--></option>
                    </select></span>
                </p>
            </td>
        </tr>
