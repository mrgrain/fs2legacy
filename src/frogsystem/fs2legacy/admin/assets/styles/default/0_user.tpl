...
<form action="" method="post">
    ...
    <table style="margin-left:-2px;" border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
            <td>
                <input class="small input input_highlight" size="20" id="password_mini" type="password"
        ...
        <tr>
            <td align="left">
                ...
                <input class="pointer textmiddle" type="checkbox" id="stayonline_mini" name="stayonline" value="1"
                       checked>
            </td>
        </tr>
        <tr>
...
<!--section-start::APPLET_ADMINLINE--><a class="small" href="{..admincp_url..}">- Admin CP</a>
<br><!--section-end::APPLET_ADMINLINE-->
...
<table style="margin-left:-2px;" border="0" cellpadding="2" cellspacing="0">
        ...
        <td align="left" valign="top" rowspan="11">
            ...
            <div align="center">
                <form action="" method="get">
                    ...
                    <button class="pointer" type="submit"><img src="$VAR(style_icons)user/user-new.gif" alt=""
                                                               align="bottom"> zur Registrierung
                    </button>
                </form>
            </div>
        </td>
    ...
    <form action="" method="post">
        ...
        <tr>
            <td align="left">
                <input class="small input input_highlight" size="33" type="password" id="password_big"
                       name="userpassword" maxlength="50"><br>
                <a href="$URL(login[newpassword=])" class="small">Passwort vergessen?</a>
            </td>
            <td align="left">
        ...
        <tr>
            <td align="center" colspan="2">
                <button class="pointer" type="submit"><img src="$VAR(style_icons)user/unlock.gif" alt="" align="bottom">
                    Anmelden
                </button>
            </td>
        </tr>
...
<p>Wenn du dein Passwort oder Benutzernamen vergessen hast, kannst du hier neue Zugangdaten anfordern. Wir ben&ouml;tigen
    dazu nur die E-Mail-Adresse, mit der du dich bei uns registriert hast.</p>
...
<form action="" method="post">
    ...
    <table border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
            <td align="left">
                <input class="input input_highlight" size="33" type="text" id="newpassword_mail" name="newpassword_mail"
                       maxlength="50">
            </td>
            <td align="center">
                <button class="pointer" type="submit"><img src="$VAR(style_icons)user/mail.gif" alt="" align="bottom">
...
<p>Falls du keinen Zugriff mehr auf diese E-Mail-Adresse haben solltest, musst du dir leider einen <a
            href="$URL(register)">neuen Account</a> anlegen.</p>
...
<div>
    ...
    <form action="" method="post" onSubmit="return checkRegistrationForm()">
        ...
        <table border="0" cellpadding="2" cellspacing="0" align="center">
            ...
            <tr>
                <td align="left">
                    <input class="small input input_highlight" size="33" name="user_mail" id="user_mail"
                           maxlength="100">
            ...
            <tr>
                <td align="left">
                    <input class="small input input_highlight" size="33" name="new_pwd" id="new_pwd" type="password"
            ...
            <tr>
                <td align="left">
                    <input class="small input input_highlight" size="33" name="wdh_pwd" id="wdh_pwd" type="password"
                           maxlength="50" autocomplete="off">
            ...
            <tr>
                <td align="center">
                    <button class="pointer" type="submit" name="register"><img src="$VAR(style_icons)user/user-new.gif"
                                                                               alt="" align="bottom"> Jetzt registrieren
                    </button>
                </td>
            </tr>
        </table>
...
<tr>
    <td align="right">
        <img class="textmiddle" src="{..captcha_url..}"> <input class="small input input_highlight" size="20"
...
<form action="" method="post" enctype="multipart/form-data" onSubmit="return checkUserEditForm()">
    ...
    <table style="margin-left:-2px;" border="0" cellpadding="2" cellspacing="0">
        ...
        <tr>
            ...
            <td align="left"><label for="user_delete_image" class="small pointer textmiddle"
                                    style="vertical-align:middle;">Aktuelles Benutzerbild l&ouml;schen?</label></td>
            <td align="center"><input type="checkbox" class="pointer" name="user_delete_image" id="user_delete_image"
                                      value="1"></td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            <td align="left" colspan="2"><b>E-Mail:</b> <span class="small">(Pflicht)</span></td>
        </tr>
        <tr>
            <td align="left"><input class="small input input_highlight" size="33" value="{..user_mail..}" id="user_mail"
                                    name="user_mail" maxlength="100"></td>
        ...
        <tr valign="middle">
            <td align="left"><label for="user_show_mail" class="small pointer textmiddle"
                                    style="vertical-align:middle;">E-Mail im &ouml;ffentlichen Profil anzeigen?</label>
            </td>
            <td align="center"><input type="checkbox" class="pointer" name="user_show_mail" id="user_show_mail"
                                      value="1" {..show_mail_checked..}></td>
        </tr>
        <tr>
            <td></td>
        </tr>
        <tr>
            <td align="left" colspan="2"><b>Homepage:</b></td>
        </tr>
        <tr>
            <td align="left"><input class="small input input_highlight" size="33" value="{..user_homepage_url..}"
                                    name="user_homepage" maxlength="100"></td>
        ...
        <tr>
            <td align="left" colspan="2"><b>ICQ-Nummer:</b></td>
        </tr>
        <tr>
            <td align="left"><input class="small input input_highlight" size="33" value="{..user_icq..}" name="user_icq"
                                    maxlength="100"></td>
        ...
        <tr>
            <td align="left" colspan="2"><b>AIM E-Mail:</b></td>
        </tr>
        <tr>
            <td align="left"><input class="small input input_highlight" size="33" value="{..user_aim..}" name="user_aim"
                                    maxlength="100"></td>
        ...
        <tr>
            <td align="left"><input class="small input input_highlight" size="33" value="{..user_wlm..}" name="user_wlm"
                                    maxlength="100"></td>
        ...
        <tr>
            <td align="left" colspan="2"><b>Yahoo!-ID:</b></td>
        </tr>
        <tr>
            <td align="left"><input class="small input input_highlight" size="33" value="{..user_yim..}" name="user_yim"
                                    maxlength="100"></td>
        ...
        <tr>
            <td align="left" colspan="2"><b>Skype-Name:</b></td>
        </tr>
        <tr>
            <td align="left"><input class="small input input_highlight" size="33" value="{..user_skype..}"
                                    name="user_skype" maxlength="100"></td>
        ...
        <tr>
            <td align="left" colspan="2"><b>Nur bei einer Passwort&auml;nderung:</b></td>
        </tr>
        <tr>
            <td></td>
        </tr>
        ...
        <tr>
            <td align="left"><input class="small input input_highlight" size="33" id="old_pwd" name="old_pwd"
                                    type="password" maxlength="50" autocomplete="off"></td>
            <td align="center"><img src="$VAR(style_icons)user/key.gif" alt="" align="bottom"></td>
            <td align="left"><input class="small input input_highlight" size="33" id="new_pwd" name="new_pwd"
                                    type="password" maxlength="50" autocomplete="off"></td>
        ...
        <tr>
            <td colspan="2"></td>
            <td align="left" colspan="2"><b>Neues Passwort wiederholen:</b></td>
        </tr>
        <tr>
            <td colspan="2"></td>
            <td align="left"><input class="small input input_highlight" size="33" id="wdh_pwd" name="wdh_pwd"
                                    type="password" maxlength="50" autocomplete="off"></td>
        ...
        <tr>
            <td align="center" colspan="5">
                <button class="pointer" type="submit" name="user_edit"><img src="$VAR(style_icons)user/unlock.gif"
                                                                            alt="" align="bottom"> Profil speichern
                </button>
            </td>
        </tr>
    ...
    <tr align="center">
        ...
        <td class="left bottom" width="110">
            <a href="{..order_reg_date..}">
                <img src="$VAR(style_icons)user/date.gif" alt="Registriert seit" title="Registriert seit"
                     align="bottom">
                <br>{..arrow_reg_date..}
            </a>
        </td>
...
<!--section-start::USERLIST_USERLINE-->
...
<!--section-start::USERLIST_STAFFLINE-->
<tr class="small" align="center">
    <td class="left">
...
<!--section-start::USERLIST_ADMINLINE-->
<tr class="small" align="center">
    <td class="left">
        <a href="{..user_url..}" class="small"><b>{..user_name..}</b></a>
    </td>
